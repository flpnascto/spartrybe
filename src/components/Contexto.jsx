...
class Contexto extends React.Component {
  render() {
    return (
      <div>
        <p>Quero investir, mas não sou especialista em investimentos, e agora ?</p>
        <p>A Órama Incipientium foi desenvolvida para você, independente do seu nível de conhecimento
         ou tempo disponível para realizar as operações.</p>
